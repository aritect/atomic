...
const badgeVariants = cva(
  "inline-flex items-center rounded-sm whitespace-nowrap px-3 py-1 text-xs font-medium transition-colors duration-global focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        "outline-default":
