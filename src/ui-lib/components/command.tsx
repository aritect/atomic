...
import { SearchIcon } from "@/icons-ui-lib/search-icon";
...
>(({ className, showIcon = true, ...props }, ref) => (showIcon ? (
...
const CommandShortcut = ({
  ...
  ...props
    ...
    <span
      className={cn(
        "text-muted-foreground ml-auto font-sans text-xs tracking-widest",
        className,
      )}
      {...props}
    />
