...
const SheetClosePrimitive = SheetPrimitive.Close;
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Close
    className={cn(
      "data-[state=open]:bg-secondary opacity-70 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none",
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "will-change-[transform] fixed z-50 gap-4 transition p-4 ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-global data-[state=open]:duration-global",
  {
    variants: {
      side: {
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({
  hideClose, side = "right", className, children, ...props
}, ref) => (
  <SheetPortal>
    <SheetOverlay />
